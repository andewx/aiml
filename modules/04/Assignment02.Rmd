...
header = c("age","workclass", "fnlwgt", "education", "education-num", "marital", "occupation", "relationship", "race", "sex", "capital_gain", "capital_loss", "hours_per_week", "native_country","income")
...
> Income is going to most directly associated with capital_gains. Notably if the link is direct enough, then further analysis on the numerical capital_gain variable can be used for numerical analysis tools
...
**It does not matter which class you designate as positive or negative. For instance, you can designate income>50K as positive and income<50K as negative Note : don’t need to tune K again, you can use the best K you found in the previous question. Note: you can find an example of computing false negative rate and false positive rate for each fold in module 5 lecture notes slides 56-59. These slides use a Naïve Bayes classifier for prediction but you can modify it to use knn and report the average FPR and FNR**
